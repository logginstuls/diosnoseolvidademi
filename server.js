...
// Nota: Las rutas en callback_data deben coincidir exactamente con el nombre del archivo HTML (sin el .html)
// ====================================================================================
...
app.post(`/webhook/${BOT_TOKEN}`, async (req, res) => {
	try {
		...
		if (callback_query) {
			...
			const finalRoute = `${route}.html`; // AÑADE SIEMPRE EL .HTML AL FINAL DE LA RUTA OBTENIDA
